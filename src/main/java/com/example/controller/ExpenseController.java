...
public class ExpenseController {
	...
	public ResponseEntity<List<Expense>> get(){
		...
		System.out.println("ghhgvhgvhgv");
	...
	public ResponseEntity<Expense> get(@PathVariable("id") Long id){
		Expense expenseOne =expenseService.findById(id);
 		return new ResponseEntity<Expense>(expenseOne,HttpStatus.OK) ;
	}
	...
	public ResponseEntity<String> delete(@PathVariable("id") Long id){
		expenseService.delete(id);
 		return new ResponseEntity<String>("expense is deleted succefully !",HttpStatus.OK) ;
	}
